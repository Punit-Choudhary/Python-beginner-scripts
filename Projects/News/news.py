...
if __name__ == '__main__':
    while True:
        ...
        countrys = {
            ...
            'Nigeria': 'ng', 'Norway': 'no', 'Philippines': 'ph',
        ...
        url = (
            f'https://newsapi.org/v2/top-headlines?country={country1.lower()}'
            '&category={category.lower()}&apiKey=YOUR_API_KEY')
        print(url)
